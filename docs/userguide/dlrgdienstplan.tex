...
\newcommand{\autor}{
Philippe Käufer, 
\href{https://github.com/Nogravitiy}{Nogravitiy} , \href{https://github.com/Rettungsschwimmer87}{Rettungsschwimmer87}
}
\newcommand{\version}{2020.1}
...
\include{Inhalt/register}
\include{Inhalt/login}
\include{Inhalt/menu}
\include{Inhalt/qualification}
\include{Inhalt/overview}
\include{Inhalt/services}
\include{Inhalt/trainings}
\include{Inhalt/news}
\include{Inhalt/prozesse}
\include{Inhalt/admin}
\include{Inhalt/module}
